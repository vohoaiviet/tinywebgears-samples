package com.tinywebgears.relayme.mail;
...
import com.tinywebgears.relayme.UserData;
...
public class LocalEmailService extends Service
{
    ...
    public void sendEmail(String subject, String text, EmailTaskCallback callback)
    {
        ...
        {
            Log.v(TAG, "Please set the target email address.");
            return;
        }
        if (!UserData.isOAuthSetUp())
        {
            Log.v(TAG, "Please configure email send method.");
            return;
        }
